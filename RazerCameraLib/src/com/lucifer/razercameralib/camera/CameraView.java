package com.lucifer.razercameralib.camera;
...
//		mMediaRecorder.setVideoSize(1280, 720);
	...
	private void startOrientationChangeListener()
	{
				...
				getContext())
		{
			...
			{
				//Log.d("---->rotation:", Integer.toString(rotation));
	...
	private void updateCameraOrientation()
	{
		if (mCamera != null)
		{
			...
			if (((mOrientation >= 0) && (mOrientation <= 45)) || (mOrientation > 315))
			{
				rotation = 270;
				preview=90;
			} 
			else if ((mOrientation > 45) && (mOrientation <= 135))
			{
				rotation=0;
				preview=180;
			} 
			...
			// 预览图片旋转90°
			mCamera.setDisplayOrientation(preview);// 预览转90°
			mCamera.setParameters(parameters);
		}
	}
	 ...
	 * @param rotation
	 */
	public void rotateOriention(int rotation)
	{
		mCamera = Camera.open();
