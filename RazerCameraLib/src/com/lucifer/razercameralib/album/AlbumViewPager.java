package com.lucifer.razercameralib.album;
...
import com.lucifer.razercameralib.R;
import com.lucifer.razercameralib.album.MatrixImageView.OnMovingListener;
import com.lucifer.razercameralib.album.MatrixImageView.OnSingleTapListener;
...
public class AlbumViewPager extends ViewPager implements OnMovingListener
{
	...
	public AlbumViewPager(Context context, AttributeSet attrs)
	{
		...
		builder = builder.showImageOnLoading(R.drawable.ic_launcher)
